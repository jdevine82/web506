        ...
        <div class="grid-y">
            ...
            <div class="cell shrink body ">
                <div class="grid-x auto  ">
                    ...
                    <div class="cell small-auto medium-auto large-auto mainpage ">
                            ...
                            <h3 class="cell small-12 ">contact form</h3>
                                ...
                                <div class="grid-x grid-margin-x">
                                    ...
                                    <div class="small-12 cell">
                                        <textarea placeholder="Write something to us" rows='4'></textarea>
                                    </div>
                    ...
                    <div class="cell small-12 medium-8 medium-offset-3 large-offset-0 large-3  newsfeed">
                        <div id="newsletter">
